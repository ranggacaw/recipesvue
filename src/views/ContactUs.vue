<template>
    <!-- Document Wrapper
    ============================================= -->
    <div id="wrapper" class="contact-recipes clearfix">

        <HeaderRecipes/>

        <!-- Page Title
        ============================================= -->
        <section id="page-title" class="page-title-parallax page-title-dark include-header skrollable skrollable-between heroContact" style="background:url('demos/recipes/images/contact-bg.jpg') center center / cover; padding: 150px 0;">

<template>
    <div class="recipes-detail">
        ...
        <!-- Page Title============================================= -->
		<section id="slider" class="slider-element dark parallax include-header skrollable skrollable-between heroContact" style="background: url('demos/recipes/images/recipe-single.jpg') center center / cover; padding: 230px 0;" data-0="background-position:0px -200px;" data-400="background-position:0px -100px;">
            <div class="container clearfix">
                <div class="mx-auto center" style="max-width: 800px">
                    <h3 class="nott fw-bold mb-5 display-4" data-animate="zoomIn">Spinach Artichoke Dip Pasta with Chicken</h3>
                </div>
                        ...
                        <div class="card-body px-4">
                                ...
                                <div class="col-12 col-xl">
                                    <div class="row justify-content-center col-mb-30">
                                        <div class="col-4 col-md">
                                            <h6 class="text-black-50 text-uppercase font-body fw-normal ls1 mb-1">Energy</h6>
                                            <h4 class="mb-0">2635</h4>
                                        </div>

                                        <div class="col-4 col-md">
                                            <h6 class="text-black-50 text-uppercase font-body fw-normal ls1 mb-1">Calories</h6>
                                        ...
                                        <div class="col-4 col-md">
                                            <h6 class="text-black-50 text-uppercase font-body fw-normal ls1 mb-1">Fat</h6>
                                            <h4 class="mb-0">7gm</h4>
                                        </div>

                                        <div class="col-4 col-md">
                                            <h6 class="text-black-50 text-uppercase font-body fw-normal ls1 mb-1">Carbs</h6>
                                            <h4 class="mb-0">82gm</h4>
                                        </div>

                                        <div class="col-4 col-md">
                                            <h6 class="text-black-50 text-uppercase font-body fw-normal ls1 mb-1">Protein</h6>
                            ...
                            <div class="row justify-content-between mt-5 mb-4 clearfix">
                                ...
                                <div class="col-lg-8 mt-5 mt-lg-0">
                                    ...
                                    <YouTube class="rounded position-relative dark mb-5"  src="https://youtube.com/shorts/bPV5Cbroq_o?feature=share" ref="youtube" width="800" />
                                            ...
                                            <li class="comment even thread-even depth-1" id="li-comment-1">
                                                ...
                                                <div id="comment-1" class="comment-wrap clearfix">
                                                    ...
                                                    <div class="comment-content clearfix">
                                                        ...
                                                        <div class="comment-author">Gunther David<span><a href="#" title="Permalink to this comment">April 24, 2012 at 10:46 am</a></span>
                                                            <small class="comment-ratings text-muted mt-2"><i class="icon-star3"></i><i class="icon-star3"></i><i class="icon-star3"></i><i class="icon-star3"></i><i class="icon-star3"></i> </small></div>
                                                    ...
                                                    <li class="comment byuser comment-author-_smcl_admin odd alt depth-2" id="li-comment-3">
                                                        ...
                                                        <div id="comment-3" class="comment-wrap clearfix">
                                                            ...
                                                            <div class="comment-content clearfix">
                                                                ...
                                                                <div class="comment-author"><a href='#' rel='external nofollow' class='url'>SemiColon</a> (Author)<span><a href="#" title="Permalink to this comment">April 25, 2012 at 1:03 am</a></span></div>
                                            ...
                                            <li class="comment byuser comment-author-_smcl_admin even thread-odd thread-alt depth-1" id="li-comment-2">
                                                ...
                                                <div id="comment-2" class="comment-wrap clearfix">
                                                    ...
                                                    <div class="comment-content clearfix">
                                                        ...
                                                        <div class="comment-author"><a href='https://themeforest.net/user/semicolonweb' rel='external nofollow' class='url'>John Doe</a><span><a href="#" title="Permalink to this comment">April 25, 2012 at 1:03 am</a></span><small class="comment-ratings text-muted mt-2"><i class="icon-star3"></i><i class="icon-star3"></i><i class="icon-star3"></i><i class="icon-star3"></i><i class="icon-star-half2"></i> </small></div>
                                            ...
                                            <form class="row" action="#" method="post" id="commentform">
                                                ...
                                                <div class="col-md-4 form-group">
                                                    ...
                                                    <div class="select-wrapper form-control-pill px-2">
                                                        <select id="rating" name="rating" class="form-select border-0">
